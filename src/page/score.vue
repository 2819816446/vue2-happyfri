    ...
    export default {
        ...
        data(){
            return{
                ...
                scoreTipsArr:['你说，是不是把知识都还给小学老师了？','还不错，但还需要继续加油哦！','不要嘚瑟还有进步的空间！','智商离爆表只差一步了！','你也太聪明啦，duancan欢迎你！'],
            
            }
        },
        computed: mapState(['answerid','allTime']), //将this.answerid 映射为store.state.answerid
        created(){
            this.computedScore();
            this.getScoreTip();
            document.body.style.backgroundImage = 'url(src/images/4-1.jpg)';
        },
        methods:{
            //计算分数
            computedScore(){
